...
export class SaleDetailComponent implements OnInit {
  ...
  async downloadComprobante(): Promise<void> {
    ...
    const data: ComprobantePago = {
      folio: this.sale.folio || this.sale._id || '',
      fecha: this.sale.fecha || new Date().toISOString(),
      cliente: {
      ...
      estatus: this.sale.estado || 'No definido',
      notas: this.sale.notas,
      qr: this.sale.qr,
    };

    await generarComprobantePDF(data);
  }
}
